...
public class ItemBowNB extends Item
{
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("irjm:NB_0");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = p_94581_1_.registerIcon( "irjm:NB_" + bowPullIconNameArray[i]);
        }
    }
