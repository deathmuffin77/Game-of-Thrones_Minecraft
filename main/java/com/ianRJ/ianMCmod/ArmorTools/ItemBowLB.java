...
public class ItemBowLB extends Item
{
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("irjm:LB_0");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = p_94581_1_.registerIcon( "irjm:LB_" + bowPullIconNameArray[i]);
        }
    }
